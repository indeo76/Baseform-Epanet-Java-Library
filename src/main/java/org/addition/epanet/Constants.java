...
public class Constants {
    ...
    public static final double LPSperCFS = 28.317d; //ile litrów/s przypada na stopę sześcienną/sekunde
    public static final double LPMperCFS = 1699.0d; //ile litrów/minute przypada na stopę szcześcienną/sekunde
    public static final double CMHperCFS = 101.94d; //ile m3/h przypada na stopę sześcienną/sekunde
    ...
    public static final double MperFT = 0.3048d; //metrów na stopę
    public static final double MMperFT = 304.8d; //mm na stopę
    public static final double INperFT = 12.0d; //cali na stopę
